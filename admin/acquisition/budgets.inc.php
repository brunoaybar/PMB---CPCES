...
// +-------------------------------------------------+
// $Id: budgets.inc.php,v 1.46 2021/03/25 13:30:17 dgoron Exp $

if (stristr($_SERVER['REQUEST_URI'], ".inc.php")) die("no access");

global $class_path, $include_path, $action;
...
function show_list_budg($id_bibli) {
	...
	print list_configuration_acquisition_budget_ui::get_instance(array('num_entite' => $id_bibli))->get_display_list();
}
