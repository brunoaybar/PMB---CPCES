...
// +-------------------------------------------------+
// $Id: amendes.inc.php,v 1.10 2021/03/12 13:21:14 dgoron Exp $
...
if ($pmb_gestion_amende==1) {
	...
	switch ($action) {
		...
		case 'modif':
			...
			$content_form=str_replace("!!amende_frais_recouvrement!!",htmlentities($finance_frais_recouvrement,ENT_QUOTES,$charset),$content_form);			
