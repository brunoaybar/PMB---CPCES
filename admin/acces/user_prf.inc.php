...
// +-------------------------------------------------+
// $Id: user_prf.inc.php,v 1.8.8.1 2021/12/22 14:18:44 dgoron Exp $

if (stristr($_SERVER['REQUEST_URI'], ".inc.php")) die("no access");

global $class_path, $include_path, $database_window_title, $action, $msg, $charset, $id, $ac, $dom, $chk_prop;
...
function show_calc_user_prf_list($id) {
	...
	$r_unused=pmb_mysql_query($q_unused);
