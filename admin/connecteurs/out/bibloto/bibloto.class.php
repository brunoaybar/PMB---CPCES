...
// +-------------------------------------------------+
// $Id: bibloto.class.php,v 1.37.2.4 2022/05/11 15:29:36 rtigero Exp $
...
\x1D\x56\x41 \x1B\x40";	
			...
			$this->config['msg_bibloto_yes'] = $this->msg['msg_bibloto_yes'];
			$this->config['msg_bibloto_no'] = $this->msg['msg_bibloto_no'];
...
/*		
		...
		<div class='row'>&nbsp;</div>
        <div class='row'>
			<label class='etiquette'>".htmlentities($this->msg['bibloto_activate_printer'],ENT_QUOTES,$charset)."</label><br />			
			<span>".htmlentities($this->msg['bibloto_rfid_activate_printer_no'],ENT_QUOTES,$charset)." &nbsp;<input type='radio' name='printer_activate' value='0' ".(!$this->config["printer_activate"] ? "checked='checked' ": "")."style='vertical-align:bottom;' /></span>
			<span>".htmlentities($this->msg['bibloto_rfid_activate_expl_yes_auto'],ENT_QUOTES,$charset)."&nbsp;<input type='radio' name='printer_activate' value='1' ".($this->config["printer_activate"] == "1" ? "checked='checked' ": "")."style='vertical-align:bottom;' /></span>
			<span>".htmlentities($this->msg['bibloto_rfid_activate_expl_yes_manual'],ENT_QUOTES,$charset)."&nbsp;<input type='radio' name='printer_activate' value='2' ".($this->config["printer_activate"] == "2" ? "checked='checked' ": "")."style='vertical-align:bottom;' /></span>
            <input type='hidden' name='printer_name' value='$pmb_printer_name' />	
		</div>
        <div class='row'>
			<label class='etiquette'>".htmlentities($this->msg['print_all_loans_activate'],ENT_QUOTES,$charset)."</label><br />			
			<span>".htmlentities($this->msg['print_all_loans_activate_no'],ENT_QUOTES,$charset)." &nbsp;<input type='radio' name='print_all_loans_activate' value='0' ".(!$this->config["print_all_loans_activate"] ? "checked='checked' ": "")."style='vertical-align:bottom;' /></span>
			<span>".htmlentities($this->msg['print_all_loans_activate_yes'],ENT_QUOTES,$charset)."&nbsp;<input type='radio' name='print_all_loans_activate' value='1' ".($this->config["print_all_loans_activate"] == "1" ? "checked='checked' ": "")."style='vertical-align:bottom;' /></span>
		</div>
        <div class='row'>
			<label class='etiquette'>".htmlentities($this->msg['msg_print_all_loans'],ENT_QUOTES,$charset)."</label><br />			
			<input type='text' class='saisie-80em' id='msg_print_all_loans' name='msg_print_all_loans' value='".htmlentities($this->config['msg_print_all_loans'],ENT_QUOTES,$charset)."' />		
		</div>
        <div class='row'>&nbsp;</div>
		<div class='row'>
		...
		<div class='row'>
			<input type='hidden' id='msg_bibloto_yes' name='msg_bibloto_yes' value='".htmlentities($this->msg['msg_bibloto_yes'],ENT_QUOTES,$charset)."' />
			<input type='hidden' id='msg_bibloto_no' name='msg_bibloto_no' value='".htmlentities($this->msg['msg_bibloto_no'],ENT_QUOTES,$charset)."' />
		</div>";
		return $result;
	}
