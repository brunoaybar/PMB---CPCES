...
// +-------------------------------------------------+
// $Id: empr_func.inc.php,v 1.113.2.7 2022/04/20 14:54:15 dgoron Exp $
...
// 	$empr_form = str_replace('!!empr_password!!', '', $empr_form);
	...
	if(password::check_ext_auth_file() === false){
    	...
    	$empr_form_password_constraints = str_replace('!!enabled_password_rules!!', "", $empr_form_password_constraints);
		$empr_form_password_constraints = str_replace("!!id!!", "", $empr_form_password_constraints);
	}
}
