...
// +-------------------------------------------------+
// $Id: entities_controller.class.php,v 1.13.8.3 2022/06/21 10:01:46 gneveu Exp $
...
class entities_controller {
	...
	public function proceed_explnum_delete() {
	    ...
	    $check = $docNumCertifier->checkSignExists();
	    if ($check) {
	        return print return_error_message($msg["540"], $msg["digital_signature_already_signed_docnum_del"], 1, "./catalog.php?categ=isbd&id=".$expl->explnum_notice);
	    }
