...
// +-------------------------------------------------+
// $Id: rent_pricing_system.class.php,v 1.4.2.1 2022/03/31 14:24:55 dgoron Exp $
...
class rent_pricing_system {
	...
	public function get_form(){
		global $msg;
		global $rent_pricing_system_content_form_tpl;
		
		$content_form = $rent_pricing_system_content_form_tpl;
		...
		$content_form = str_replace("!!desc!!",$this->desc,$content_form);
		$entity = $this->get_entity();
		$content_form = str_replace("!!associated_entity!!",$entity->raison_sociale,$content_form);
		$content_form = str_replace("!!exercices!!",$this->gen_selector_exercices(),$content_form);
