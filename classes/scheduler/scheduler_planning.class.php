...
// +-------------------------------------------------+
// $Id: scheduler_planning.class.php,v 1.14.2.3 2022/05/17 13:05:09 dgoron Exp $
...
class scheduler_planning {
	...
	public function get_form() {
		...
		if (!$this->id) {
			$bt_save=static::format_url("&act=task&type_task_id=".$this->id_type);
			$bt_duplicate="";
			$bt_suppr="";
		} else {
			$bt_save=static::format_url("&act=task&type_task_id=".$this->id_type."&planificateur_id=".$this->id);
			$bt_duplicate="<input type='button' class='bouton' value='".$msg["tache_duplicate_bouton"]."' onclick='document.location=\"".static::format_url("&act=task_duplicate&type_task_id=".$this->id_type."&planificateur_id=".$this->id)."\"' />";
			$bt_suppr="<input type='button' class='bouton' value='".$msg["63"]."' onClick='location.href=\"".static::format_url("&act=task_del&type_task_id=".$this->id_type."&planificateur_id=".$this->id)."\"'/>";
		}
	...
	public function delete() {
		...
		if ($value_statut == "0") {
			...
			<a href='".static::format_url("&act=task_del&type_task_id=".$this->id_type."&planificateur_id=".$this->id."&confirm=1")."'>
			".$msg["40"]."
			</a> - <a href='".static::format_url("&type_task_id=".$this->id_type."&planificateur_id=".$this->id."&confirm=0")."'>
			".$msg["39"]."
				</a>
				</div>
			";
			...
			<a href='".static::format_url("&act=task_del&type_task_id=".$this->id_type."&planificateur_id=".$this->id."&disabled=1")."'>
			".$msg["40"]."
			</a> - <a href='".static::format_url("&type_task_id=".$this->id_type."&planificateur_id=".$this->id."&disabled=0")."'>
			".$msg["39"]."
				</a>
				</div>
			";
