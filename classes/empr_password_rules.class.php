...
// +-------------------------------------------------+
// $Id: empr_password_rules.class.php,v 1.2.2.1 2022/03/21 09:55:21 gneveu Exp $
...
class empr_password_rules {
	...
	public static function get_form() {
		...
		$form = static::$templates['form'];
 		...
 		// On affiche un message pour prevenir si il y a un fichier ext_aut
 		$form = str_replace('!!admin_empr_password_no_rules_ext_auth!!', (password::check_ext_auth_file() ? "display:block" : "display:none"), $form);
