...
// +-------------------------------------------------+
// $Id: scan_request.class.php,v 1.47.2.5 2022/04/04 07:36:35 dgoron Exp $
		...
		if ($request_creation || $this->loc_updated) {
			...
			if ($pmb_scan_request_location_activate) {
				...
				if ($location->email) {		
					...
					$content = str_replace("!!permalink!!", $this->get_formatted_permalinks(), $content);
