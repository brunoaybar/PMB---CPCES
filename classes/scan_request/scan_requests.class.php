...
// +-------------------------------------------------+
// $Id: scan_requests.class.php,v 1.20.2.2 2022/03/31 14:24:55 dgoron Exp $
...
class scan_requests {
	...
	public static function get_admin_form(){
		...
		$content_form = $scan_request_parameters_content_form;
		...
		$content_form = str_replace("!!scan_request_parameters_folder_selector!!",$params_form,$content_form);
