...
// +-------------------------------------------------+
// $Id: explnum_licence_profile.class.php,v 1.9.2.1 2022/03/31 14:24:55 dgoron Exp $
...
class explnum_licence_profile {
	...
	public function get_form() {
		global $admin_explnum_licence_profile_content_form, $msg;
		
		$content_form = $admin_explnum_licence_profile_content_form;
		...
		$content_form = str_replace('!!explnum_licence_profile_label!!', $this->get_label(), $content_form);
		$content_form = str_replace('!!explnum_licence_profile_uri!!', $this->get_uri(), $content_form);
		$content_form = str_replace('!!explnum_licence_profile_logo_url!!', $this->get_logo_url(), $content_form);
		$content_form = str_replace('!!explnum_licence_profile_explanation!!', $this->get_explanation(), $content_form);
		$content_form = str_replace('!!explnum_licence_profile_quotation_rights!!', $this->get_quotation_rights(), $content_form);
		$content_form = str_replace('!!quotation_variable_selector!!', $this->get_quotation_variables_selector(), $content_form);
		$content_form = str_replace('!!explnum_licence_profile_linked_rights!!', $this->generate_rights_checkboxes(), $content_form);
