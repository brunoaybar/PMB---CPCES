...
// +-------------------------------------------------+
// $Id: users_controller.class.php,v 1.1.2.4 2022/04/22 11:33:50 dgoron Exp $
...
class users_controller extends lists_controller {
	...
	public static function proceed_update($id=0) {
		...
		global $form_user_alert_resamail, $pmb_contribution_area_activate, $form_user_alert_contribmail, $demandes_active, $form_user_alert_demandesmail;
		...
		global $duplicate_from_userid, $sel_group;
