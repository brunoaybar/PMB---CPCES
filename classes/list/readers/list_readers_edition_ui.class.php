...
// +-------------------------------------------------+
// $Id: list_readers_edition_ui.class.php,v 1.15.2.4 2022/03/22 11:03:54 dgoron Exp $
	...
	protected function init_default_selection_actions() {
		...
		switch ($sub) {
			...
			case 'depasse':
				...
				$this->add_selection_action('print_all_relances', $msg["print_all_relances"], 'doc.gif', $link);
				break;
		}
		if ($empr_show_caddie) {
			$link = array(
