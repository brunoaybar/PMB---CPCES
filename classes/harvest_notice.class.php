...
// +-------------------------------------------------+
// $Id: harvest_notice.class.php,v 1.6.2.1 2022/04/22 07:16:36 dgoron Exp $
...
//							printr($uni_field);
    ...
    public function record_notice($notice_id){
    	...
    	print "
			...
			<script type=\"text/javascript\">document.location='".notice::get_permalink($notice_id)."'</script>
		";
    	printr($ret);
    }
