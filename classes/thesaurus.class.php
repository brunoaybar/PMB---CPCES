...
// +-------------------------------------------------+
// $Id: thesaurus.class.php,v 1.31.2.2 2022/05/05 08:04:13 dgoron Exp $
...
class thesaurus {
	...
	public function get_form() {
		global $msg, $charset;
		global $thes_content_form;
		global $include_path;
		global $lang;
		
		$form = $this->get_js_form();
		
		$content_form = $thes_content_form;
		...
		$content_form = str_replace('!!id_thes!!', $this->id_thesaurus, $content_form);
		$content_form = str_replace('!!identifiant_thesaurus!!', $identifiant_thesaurus, $content_form);
		$content_form = str_replace('!!libelle_thesaurus!!', $this->libelle_thesaurus, $content_form);
		$content_form = str_replace('!!langue_defaut!!', $langue_defaut, $content_form);
