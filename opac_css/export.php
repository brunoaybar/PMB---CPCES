...
// +-------------------------------------------------+
// $Id: export.php,v 1.26.8.3 2022/03/17 14:02:23 dgoron Exp $

$base_path=".";
require_once($base_path."/includes/init.inc.php");

global $include_path, $action, $msg, $popup_header, $popup_footer;
global $select_item, $opac_export_allow, $opac_export_allow_expl;
...
if (($opac_export_allow=='1') || (($opac_export_allow=='2') && ($_SESSION["user_code"]))) {
	...
	if($action == 'select'){
	    ...
	    $form .= "<input type='hidden' name='notice_id' value='$notice_id' />";

	    $form .= "<span class=\"export_notice_button\">&nbsp;</span><input type='submit' class='bouton' value=\"{$msg['notice_title_export_record_button']}\" />";
	    $form .= '</form>
                    <div align="center" class="close_export_popup"><a href="#" onclick="window.close()">'.$msg['close_export_record_popup'].'</a></div>
                    </div>';
	    print $form;
	    print $popup_footer;
