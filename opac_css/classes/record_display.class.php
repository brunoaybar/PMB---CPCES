...
// +-------------------------------------------------+
// $Id: record_display.class.php,v 1.116.2.3 2022/01/27 08:43:48 rtigero Exp $
...
// 				$coins_span.="book";
	...
	static public function get_display_export($notice_id){
	    global $msg;
	    return "<a href='#' title=\"{$msg['notice_title_export_record']}\" onclick=\"openPopUp('export.php?action=select&notice_id=$notice_id','exporter_la_notice'); return false;\">{$msg['notice_title_export_record']}</a>";
