...
// +-------------------------------------------------+
// $Id: facettes_root.class.php,v 1.53.2.4 2022/05/23 08:43:51 rtigero Exp $
	...
	public function create_ajax_table_facettes(){
		...
		if(count($this->get_not_clicked())){
			if(static::get_compare_notice_active()){
				...
				$table .= "<h3 class='facette_compare_listTitle'>".htmlentities($msg['facette_list_compare'],ENT_QUOTES,$charset)."</h3>".$this->get_display_not_clicked()."<br/>";
			}else{
