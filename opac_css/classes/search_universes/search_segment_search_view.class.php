...
class search_segment_search_view extends search_view {
	...
	public static function get_search_others_tab($search_type_asked, $label) {
	    ...
	    return "<li ".(static::$search_type == $search_type_asked  && empty($onglet_persopac)? "id='current'" : "")."><a href=\"".static::format_url("search_segment_type=".$search_type_asked."&search_index=".$search_index)."\">".$label."</a></li>";
	}
