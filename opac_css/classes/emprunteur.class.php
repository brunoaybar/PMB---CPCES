...
// +-------------------------------------------------+
// $Id: emprunteur.class.php,v 1.41.2.6 2022/06/22 13:05:15 qvarin Exp $
  ...
  global $class_path;
	...
	class emprunteur {
		...
		public function forgotten_password_email($email) {
			...
			$messagemail = str_replace("!!empr_name!!", $this->nom, $messagemail);
			$messagemail = str_replace("!!empr_fistname!!", $this->prenom, $messagemail);
			$messagemail = str_replace("!!localisation!!", $this->empr_location_l, $messagemail);
