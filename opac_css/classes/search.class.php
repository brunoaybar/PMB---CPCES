...
// +-------------------------------------------------+
// $Id: search.class.php,v 1.361.2.39 2022/06/13 13:10:50 tsamson Exp $
	...
	public function make_human_query() {
		...
		if(is_array($search) && count($search)){
			for ($i=0; $i<count($search); $i++) {
				...
				$field_aff = $this->make_field_aff($s, $field, $field1, $fieldvar, $i);
