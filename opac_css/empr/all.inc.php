...
// +-------------------------------------------------+
// $Id: all.inc.php,v 1.85.2.1 2021/06/25 07:38:43 dgoron Exp $

if (stristr($_SERVER['REQUEST_URI'], ".inc.php")) die("no access");

global $base_path, $class_path, $include_path, $msg, $charset, $lvl, $dest, $id_empr, $id_groupe;
global $opac_pret_prolongation, $opac_pret_duree_prolongation, $opac_pret_prolongation_blocage, $allow_prol;
global $pmb_pret_restriction_prolongation, $pmb_pret_nombre_prolongation, $pmb_pret_date_retour_adhesion_depassee;
...
if ($dest=="TABLEAU") {
	...
	if($prolonge_id>0 && $opac_pret_prolongation==1){
		...
		if ($prolongation == TRUE) {
			...
			$res_arc=pmb_mysql_query("select pret_arc_id from pret where pret_idexpl=".$prolonge_id."");
...
function aff_pret_groupes(){
    global $msg,$charset,$id_empr,$lvl;
	global $opac_pret_groupe_prolongation,$opac_pret_duree_prolongation, $allow_prol;
