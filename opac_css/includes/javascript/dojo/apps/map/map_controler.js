...
// +-------------------------------------------------+
// $Id: map_controler.js,v 1.17.2.1 2022/06/27 13:57:19 tsamson Exp $
				  ...
				  for(var key2 in feature[key])
					{
                        ...
                        } else if (key2 == 'components') {
                        	clonedObj[key][key2] = feature[key][key2];
                        	if (clonedObj[key][key2].length > 1) {
                        		for (var i = 0; i < clonedObj[key][key2].length; i++) {
                        			clonedObj[key][key2][i]["id"] = 'new id' + clonedObj[key][key2][i]["id"];
						  		}
                        	}
                        } else {
							  clonedObj[key][key2]= feature[key][key2];  
