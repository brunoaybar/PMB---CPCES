...
// +-------------------------------------------------+
// $Id: cms_module_common_datasource_all_sections.class.php,v 1.5.10.1 2022/03/22 11:09:48 arenou Exp $
...
class cms_module_common_datasource_all_sections extends cms_module_common_datasource_list{
	...
	public function get_datas(){
	    //Si y'a déjà du monde dans le tableau, on est déjà passé par la !
	    if(count($this->all_section_order) > 0){
