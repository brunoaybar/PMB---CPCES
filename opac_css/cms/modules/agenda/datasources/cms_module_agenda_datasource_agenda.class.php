...
// +-------------------------------------------------+
// $Id: cms_module_agenda_datasource_agenda.class.php,v 1.21.2.1 2022/02/18 09:02:59 dgoron Exp $
				...
				if($selector){
					...
					if(pmb_mysql_num_rows($result)){
						...
						foreach($calendars as $calendar){
							...
							$query="select id_article from cms_articles where article_num_type = '".((int) $elem['type'])."'";
							$result = pmb_mysql_query($query);
