...
// +-------------------------------------------------+
// $Id: empr.tpl.php,v 1.214.2.15 2022/04/26 09:50:39 dgoron Exp $
...
global $empr_content_form, $empr_content_form_newgrid, $empr_form_password_constraints, $empr_content_form_password_with_ext_auth, $empr_content_form_mail_with_ext_auth;
...
$empr_content_form_mail_with_ext_auth = "
<div class='row'>
	<label for='form_mail' class='etiquette'>".$msg[58]."</label>
</div>
<div class='row'>
	<input type='text'  id='form_mail_input' class='saisie-40em' size=50 id='form_mail' name='form_mail' value='!!mail!!'/>
</div>
";
...
$empr_content_form_password_with_ext_auth = "
<div class='row'>
...
<div class='form-empr-fgrp ui-clearfix' id='g0' etirable='yes' >
	...
	<div class='colonne_suite' id='g0_r3_f2' movable='yes' title='".$msg[58]."' >
        " . ((password::check_ext_auth_file() === false) ? $empr_content_form_mail : $empr_content_form_mail_with_ext_auth) . "
	</div>
	<div class='row'></div>
</div>
<div class='row'></div>
...
$empr_content_form .= "
	<div class='colonne_suite' id='g4_r0_f3' movable='yes'  title='".htmlentities($msg['empr_password'],ENT_QUOTES,$charset)."' >
		" . ((password::check_ext_auth_file() === false) ? $empr_content_form_password : $empr_content_form_password_with_ext_auth) . "
	</div>
