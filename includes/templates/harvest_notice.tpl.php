...
// +-------------------------------------------------+
// $Id: harvest_notice.tpl.php,v 1.3 2021/01/29 09:34:18 dgoron Exp $

if (stristr($_SERVER['REQUEST_URI'], ".tpl.php")) die("no access");

$harvest_notice_tpl="	
<h3>".htmlentities($msg["harvest_notice_sel_notice"], ENT_QUOTES, $charset)."</h3>			
<form class='form-".$current_module."' id='harvest' name='harvest'  method='post' action=\"./catalog.php?categ=harvest&notice_id=!!notice_id!!&action=profil\" >
