		...
		<table>
			<tr>
				...
				<th>{{ pmb.getMessage("animation", "list_registration_phone") }}</th>
 				<th style="cursor:pointer;" @click="setSort('nbRegisteredPersons')">{{ pmb.getMessage("animation", "registration_nb_persons") }} <i :class="getClassSort('nbRegisteredPersons')"></i></th>
