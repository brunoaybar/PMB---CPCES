...
// +-------------------------------------------------+
// $Id: scan_request.tpl.php,v 1.31 2021/04/28 07:55:42 dgoron Exp $
...
<script type="text/javascript">
	function test_form(form) {
        ...
        if ('.$pmb_scan_request_empr_mandatory.' && document.getElementById("scan_request_num_dest_empr").value) {
