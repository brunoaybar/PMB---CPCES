...
// +-------------------------------------------------+
// $Id: rent_pricing_system.tpl.php,v 1.3.8.1 2022/03/31 14:24:55 dgoron Exp $

if (stristr($_SERVER['REQUEST_URI'], ".tpl.php")) die("no access");

global $rent_pricing_system_content_form_tpl, $msg, $charset;

$rent_pricing_system_content_form_tpl = "
