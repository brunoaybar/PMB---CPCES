...
$enlace= mysqli_connect("localhost", "root", "Fatima$2022", "test_pmb");
 ...
 $data = new Spreadsheet_Excel_Reader("profesionales.xls");
 $data->setOutputEncoding('CP1251');
 $data->read('profesionales.xls');
 $cont = 0;
 ...
 for ($i = 1; $i <= 5419; $i++) { 
	  ...
	  $consulta2=null;
		...
		{  
			...
			empr_modif,
			empr_statut,
			empr_lang) VALUES ('$dni','$ape','$nom','$mail','$año',1,2,1,'$dni','$dni','2024-03-31','CARGADO POR ALVARO','2023-03-31','2023-03-31 00:00:00','2023-03-31 00:00:00',2,'es_ES')";
